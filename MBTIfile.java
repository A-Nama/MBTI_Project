...
public class MBTIfile{
        ...
        try (Scanner Filescanner = new Scanner(new File(filename))) {
            while (Filescanner.hasNextLine()) {
                ...
                while (true) {
                    ...
                    progress =  answered * 100 / 20; // Update progress
    ...
    class ProgressUpdater extends Thread {
        MBTIfile mbti; // Reference to the outer class

        ProgressUpdater(MBTIfile mbti) {
            this.mbti = mbti;
        }
    ...
    public static void main(String[] args){
        ...
        MBTIfile user = new MBTIfile();
        MBTIfile.ProgressUpdater progressUpdater = user.new ProgressUpdater(user); // Pass user to ProgressUpdater
